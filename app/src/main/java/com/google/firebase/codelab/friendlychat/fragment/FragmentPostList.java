 ...
 */
public abstract class FragmentPostList extends Fragment {
    private static final String TAG = FragmentPostList.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_all_posts);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Query postQuery = getQuery(databaseReference);
        mAdapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(Post.class,
                R.layout.item_post, PostViewHolder.class, postQuery) {
            @Override
            protected void populateViewHolder(PostViewHolder viewHolder,final Post model, int position) {
                ...
                if (model.stars.containsKey(getUid())) {
                    viewHolder.starView.setImageResource(R.drawable.ic_star_solid);
                } else {
                    viewHolder.starView.setImageResource(R.drawable.ic_star_border);
                }
